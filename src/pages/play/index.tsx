        ...
        <div className='w-full flex flex-col items-center justify-center pb-20'>
          ...
          <div className='mt-10 flex flex-col items-center'>
            <div className='flex gap-10'>
              <Button
                label='heads'
                className='!rounded-[18px] !text-3xl'
            ...
            <div className='grid grid-cols-3 gap-6'>
              <Button
                ...
                selected={betAmount === 1}
              />
              <Button
                label='2 sui'
                className='!rounded-[18px] !text-3xl'
                onClick={() => setBetAmount(2)}
                selected={betAmount === 2}
              />
              <Button
                label='5 sui'
                className='!rounded-[18px] !text-3xl'
            ...
            <div className='mt-8'>
              <Button
                label='play'
                className='!rounded-[40px] !text-4xl !bg-[#1D4F88]'
